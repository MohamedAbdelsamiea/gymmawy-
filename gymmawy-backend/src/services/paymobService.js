...
class PaymobService {
  constructor() {
    ...
    // Use live integration IDs for production
    ...
    if (!this.integrationIdCard) {
      console.warn('Paymob live integration ID missing. Please set PAYMOB_MIGS_INTEGRATION_ID in environment variables.');
    }
    ...
    console.log('- Live Integration ID (Card):', this.integrationIdCard ? '✓ Configured' : '✗ Missing');
    console.log('- Live Integration ID (Apple Pay):', this.integrationIdApplePay ? '✓ Configured' : '✗ Missing');
