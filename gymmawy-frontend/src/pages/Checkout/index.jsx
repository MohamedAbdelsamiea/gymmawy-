  ...
  const handlePaymobPayment = async () => {
    try {
      ...
      if (result.success && result.checkoutUrl) {
        showSuccess(t('checkout.redirectingToPayment'));
        ...
        throw new Error(t('checkout.paymentIntentionFailed'));
      }
                        ...
                        <>
                          ...
                          <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                            ...
                            <div className={`${i18n.language === 'ar' ? 'mr-3' : 'ml-3'} flex items-center`}>
                              ...
                              <span className="text-sm font-medium text-gray-900">{t('checkout.creditDebitCard')}</span>
                            </div>
                          </label>
                          ...
                          <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                            ...
                            <div className={`${i18n.language === 'ar' ? 'mr-3' : 'ml-3'} flex items-center`}>
                              ...
                              <span className="text-sm font-medium text-gray-900">{t('checkout.applePay')}</span>
                            </div>
                          </label>
                        </>
                      )}
